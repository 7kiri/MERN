    ...
    return (
      <div className='full-height'>
        <div className='header'>
          <label style={HS1}>KL University |student portal</label>
        ...
        <div className='content'>
          ...
          <div className='outlet'>
            ...
            <body>
              <div class="outer-box">
                <div>no courses </div>
                <div><input type='text' id='T1' className='txtbox4' /></div>
                <div style={space1}></div>
                <div>course name</div>
                <div><input type='text' id='T2' className='txtbox4' /></div>
                <div style={space1}></div>
                <div>course student id</div>
                <div><input type='text' id='T3' className='txtbox4' /></div>
                <div style={space1}></div>
                <div> course  no</div>
                <div><input type='text' id='T4' className='txtbox4' /></div>
                <div style={space1}></div>
                <div>no of credits</div>
                <div><input type='text' id='T4' className='txtbox4' /></div>
                <div style={space1}></div>
                <div>CGPA</div>
                <div><input type='text' id='T5' className='txtbox4' /></div>
                <div style={space1}></div>
                <div><button className='btn1' onClick={this.Submit}>Submit</button></div>
